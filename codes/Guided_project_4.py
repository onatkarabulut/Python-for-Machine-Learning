...
def calculate_performance(employe_name ):
    ...
    score=average_deal_size*revenue/num_call
    return score
###Try it out
...
idx_best_performer=np.argmax(data[4])
idx_worst_performer=np.argmin(data[4])

#Print out the results
print(f'Best performes:{names[idx_best_performer]}')
print(f'Worst performer:{names[idx_worst_performer]}')